...
- load and init react app (see duw, but on page load)
- hide the existing gwt controls
- change flushVertragsdaten so that it reads from document.personenDaten instead from gwt form
